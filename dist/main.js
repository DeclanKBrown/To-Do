...
class UI {
    ...
    static loadHome() {
        ...
        const now = new Date();
        const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(now, 'dd/MM/yyyy');
